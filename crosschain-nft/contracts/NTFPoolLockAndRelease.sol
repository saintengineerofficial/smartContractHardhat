...
contract NFTPoolLockAndRelease is CCIPReceiver, OwnerIsCreator {
    ...
    function lockAndSendNFT(uint256 tokenId,address newOwner,uint64 chainSelector,address receiver) public 
    returns (bytes32) {
        // transfer nft to this address to lock and send
        ...
        override
    {
        ...
        // 不需要检查，因为transferFrom会检查token是否被锁定

        // 解锁nft,把nft转移到newOwner（原链的地址）
